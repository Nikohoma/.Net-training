...
public interface IProducer<out T>                         // TODO: make this covariant (out) ; Covariance : you can substitute a more derived type. Works only with return
{
    T Produce();                                      // Produces T
}

// ✅ TODO: Students must fix variance keywords here
public interface IConsumer<in T>                         // TODO: make this contravariant (in) : substitute a less derived type. Works only when type is used as an input.
{
