...
namespace AdventureWorksDbContrxt.Data;
...
public partial class AdventureWorksDbContext : DbContext
{
    ...
    public virtual DbSet<Person_Practice> Person_Practice { get; set; }
    ...
    public virtual DbSet<SOH_Practice> SOH_Practice { get; set; }

    public virtual DbSet<SalesOrderDetail> SalesOrderDetail { get; set; }

    public virtual DbSet<SalesOrderDetail_Practice> SalesOrderDetail_Practice { get; set; }
    ...
    public virtual DbSet<perf_issue> perf_issue { get; set; }

    public virtual DbSet<perf_issue_vw> perf_issue_vw { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=SSN\\SQLEXPRESS;Initial Catalog=AdventureWorks2025;Integrated Security=True;Connect Timeout=30;Encrypt=True;TrustServerCertificate=True; ");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AWBuildVersion>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Current version number of the AdventureWorks 2025 sample database. "));
        ...
        modelBuilder.Entity<Person_Practice>(entity =>
        {
            entity.HasNoKey();

            entity.HasIndex(e => e.LastName, "IX_Person_Practice_LastName");
        ...
        modelBuilder.Entity<SOH_Practice>(entity =>
        {
            entity.HasNoKey();
        ...
        modelBuilder.Entity<SalesOrderDetail_Practice>(entity =>
        {
            entity.HasNoKey();

            entity.HasIndex(e => e.ProductID, "CX_SOD_Practice_ProductID").IsClustered();
        ...
        modelBuilder.Entity<perf_issue>(entity =>
        {
            entity.HasNoKey();
        ...
        modelBuilder.Entity<perf_issue_vw>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("perf_issue_vw");
