...
namespace AdventureWorksDbContrxt.Controllers
{
    ...
    {
        private readonly AdventureWorksDbContext _context;   // private object of AdventureWorksDbContext type. AdventureWorksDbContext(artifact of db) is a class that has all the dbSet/tables.

        public CurrenciesController(AdventureWorksDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Currency.OrderBy(n=>n.Name).ToListAsync());
        }
        ...
        {
            return _context.Currency.Any(e => e.CurrencyCode == id);
        }
    }
}
